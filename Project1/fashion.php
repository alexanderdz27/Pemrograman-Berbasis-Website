...
<body>
  ...
  <header id="header2" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="fashion.php">Fashion</a></li>
                    ...
                    while($row = mysqli_fetch_array($query_run))
                    {
                        ?>
                          ...
                          <div class="entertainment-items">
                            <a id="delete<?php echo $row['id_fashion'] ?>">
                              <img src="assets/img/fashion/<?php echo $row['id_fashion'];?>.jpg" class="apel" alt="gambar db" height="300px" width="300px">
                                <div class="portfolio-info">
                                  <a id="delete2<?php echo $row['id_fashion'] ?>">
                                    <h4><?php echo $row['judul']; ?></h4>
                                    <p><?php echo $row['deskripsi']; ?></p>
                                    <p><?php echo $row['kategori']; ?></p>
                                    <div class="updatedata">
                                      <a id="delete3<?php echo $row['id_fashion'] ?>">  
                                        <button onclick="editAjax(<?php echo $row['id_fashion'];  ?>)"  class="btn btn-danger">edit</button>
                                        <button onclick="deleteAjax(<?php echo $row['id_fashion'];  ?>)"  class="btn btn-danger">delete</button>
                                      </a>
                                  </a>
                              </a>
                                </div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <form action="create_fashion.php" method="POST">
...
<script type="text/javascript">
	 ...
	 function deleteAjax(id_fashion){
       ...
       if(confirm('are You sure?')){
         ...
         $.ajax({
              ...
              type:'post',
              url:'delete_fashion.php',
              data:{delete_id:id_fashion},
              success:function(data){
              
                   $('#delete'+id_fashion).hide('slow');
                   $('#delete2'+id_fashion).hide('slow');
                   $('#delete3'+id_fashion).hide('slow');
              }
