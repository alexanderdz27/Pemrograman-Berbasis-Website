    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active " href="food.php">Food & Beverage</a></li>
                    ...
                    while($row = mysqli_fetch_array($query_run))
                    {
                        ?>
                          ...
                          <div class="entertainment-items">
                            <a id="delete<?php echo $row['id_food'] ?>">
                              <img src="assets/img/food/<?php echo $row['id_food'];?>.jpg" class="apel" alt="gambar db" height="300px" width="300px">
                                <div class="portfolio-info">
                                  <a id="delete2<?php echo $row['id_food'] ?>">
                                    <h4><?php echo $row['judul']; ?></h4>
                                    <p><?php echo $row['deskripsi']; ?></p>
                                    <p><?php echo $row['kategori']; ?></p>
                                    <div class="updatedata">
                                      <a id="delete3<?php echo $row['id_food'] ?>">  
                                        <button onclick="editAjax(<?php echo $row['id_food'];  ?>)"  class="btn btn-danger">edit</button>
                                        <button onclick="deleteAjax(<?php echo $row['id_food'];  ?>)"  class="btn btn-danger">delete</button>
                                      </a>
                                  </a>
                              </a>
                                </div>
	 ...
	 function deleteAjax(id_food){
       ...
       if(confirm('are You sure?')){
         ...
         $.ajax({
              ...
              type:'post',
              url:'delete_food.php',
              data:{delete_id:id_food},
              success:function(data){
              
                   $('#delete'+id_food).hide('slow');
                   $('#delete2'+id_food).hide('slow');
                   $('#delete3'+id_food).hide('slow');
              }
