...
<body>
  ...
  <header id="header2" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="technology.php">Technology</a></li>
                    ...
                    while($row = mysqli_fetch_array($query_run))
                    {
                        ?>
                          ...
                          <div class="entertainment-items">
                            <a id="delete<?php echo $row['id_technology'] ?>">
                              <img src="assets/img/technology/<?php echo $row['id_technology'];?>.jpg" class="apel" alt="gambar db" height="300px" width="300px">
                                <div class="portfolio-info">
                                  <a id="delete2<?php echo $row['id_technology'] ?>">
                                    <h4><?php echo $row['judul']; ?></h4>
                                    <p><?php echo $row['deskripsi']; ?></p>
                                    <p><?php echo $row['kategori']; ?></p>
                                    <div class="updatedata">
                                      <a id="delete3<?php echo $row['id_technology'] ?>">  
                                        <button onclick="editAjax(<?php echo $row['id_technology'];  ?>)"  class="btn btn-danger">edit</button>
                                        <button onclick="deleteAjax(<?php echo $row['id_technology'];  ?>)"  class="btn btn-danger">delete</button>
                                      </a>
                                  </a>
                              </a>
                                </div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <form action="create_technology.php" method="POST">
                                  ...
                                  <div class="row mb-3">
                                      ...
                                      <div class="col-sm-10 col-12 mt-1">
                                          <select class="form-select" id="kategori" name="kategori" required="required">
                                              ...
                                              <option value="music">Smartphone</option>
...
<script type="text/javascript">
	 function deleteAjax(id_technology){
       ...
       if(confirm('are You sure?')){
         ...
         $.ajax({
              ...
              data:{delete_id:id_technology},
              success:function(data){
              
                   $('#delete'+id_technology).hide('slow');
                   $('#delete2'+id_technology).hide('slow');
                   $('#delete3'+id_technology).hide('slow');
              }
