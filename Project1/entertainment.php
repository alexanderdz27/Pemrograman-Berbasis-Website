...
<body>
  ...
  <header id="header2" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="entertainment.php">Entertaiment</a></li>
          ...
          <li><a class="nav-link scrollto" href="travel.php">Travel</a></li>
    ...
    <section id="entertaiment" class="entertaiment">
                    ...
                    while($row = mysqli_fetch_array($query_run))
                    {
                        ?>
                          ...
                          <div class="entertainment-items">
                            <a id="delete<?php echo $row['id_entertainment'] ?>">
                              <img src="assets/img/entertainment/<?php echo $row['id_entertainment'];?>.jpg" class="apel" alt="gambar db" height="300px" width="300px">
                                <div class="portfolio-info">
                                  <a id="delete2<?php echo $row['id_entertainment'] ?>">
                                    <h4><?php echo $row['judul']; ?></h4>
                                    <p><?php echo $row['deskripsi']; ?></p>
                                    <p><?php echo $row['kategori']; ?></p>
                                    <div class="updatedata">
                                      <a id="delete3<?php echo $row['id_entertainment'] ?>">  
                                        <button onclick="editAjax(<?php echo $row['id_entertainment'];  ?>)"  class="btn btn-danger">edit</button>
                                        <button onclick="deleteAjax(<?php echo $row['id_entertainment'];  ?>)"  class="btn btn-danger">delete</button>
                                      </a>
                                  </a>
                              </a>
                                </div>
    ...
    </section><!-- End entertaiment Section -->
    ...
    <div class="modal-dialog modal-lg">
        ...
        <form action="create_entertainment.php" method="POST">
...
<script type="text/javascript">
	 ...
	 function deleteAjax(id_entertainment){
       ...
       if(confirm('are You sure?')){
         ...
         $.ajax({
              ...
              type:'post',
              url:'delete_entertainment.php',
              data:{delete_id:id_entertainment},
              success:function(data){
              
                   $('#delete'+id_entertainment).hide('slow');
                   $('#delete2'+id_entertainment).hide('slow');
                   $('#delete3'+id_entertainment).hide('slow');
              }
